...
import 'package:provider/provider.dart'; // ✅ Provider 관련 위젯 사용

// 필요한 화면들을 임포트합니다.
// 실제 파일 경로에 맞게 수정해주세요.
import '../presentation/screens/doctor/d_home_screen.dart'; // ✅ 추가
import '../presentation/viewmodel/history_viewmodel.dart'; // ✅ HistoryViewModel import
...
import '/presentation/screens/result_screen.dart'; // 사진으로 예측하기 결과 화면
import '/presentation/screens/history_screen.dart'; // 이전결과 보기 화면
import '/presentation/screens/clinics_screen.dart'; // 주변 치과 화면
import '/presentation/screens/clinics_map_screen.dart'; // 주변 치과 지도 화면
    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: '/clinics/map',
            builder: (context, state) => const ClinicsMapScreen(), // 지도로 보기 화면
          ),
